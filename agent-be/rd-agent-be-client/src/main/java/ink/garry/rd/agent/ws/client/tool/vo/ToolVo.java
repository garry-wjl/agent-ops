...
/**
 * 工具 Vo（列表项 / 命令返回 / 详情主体，adapter 层出参）。
 * <p>
 * 承载工具全字段快照（含各形态专有字段 + 系统派生的 reuseCount / endpointMeta）；
 * 由 application 的 {@code ToolDTO} 经 {@code ToolVoAssembler} 转换而来。
 * status / type / creationMode 为枚举字符串，前端映射中文与色彩。
 */
@Data
public class ToolVo {
    ...
    private EndpointMetaVo endpointMeta;
